...
private:
    ...
    bool CheckShaderTypeChange(FString &strfbxName, FString shaderType, USkeletalMesh *mesh, UMaterial* material, UMaterialInterface* MaterialInterface, RLMaterialData* pMaterialData, int slotID, FString &rootGamePath, bool isMaterialInstance );
    ...
    void GetShaderRenameMap( FString strMaterialName, RLShaderData* pShader, ENodeType eNodeType, TMap< FString, FString >& kRenameMap );
    ...
    void ParseJsonShaderData( TSharedPtr< RLMaterialData > spMaterialData, TSharedPtr< FJsonObject > spJsonObject, FString strMaterialName );
    ...
    EShaderType GetShaderType( const RLShaderData* pShaderData, FString strMaterialName );
